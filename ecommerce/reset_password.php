...
if (isset($_POST['reset'])) {
  if(strlen($_POST['email'])<1 || strlen($_POST['pw1'])<1 || strlen($_POST['pw1'])<1 || strlen($_POST['pass'])<1){
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Welcome Back ! <br>
                                Please set a new password</h3>
                            <?php if(isset($_SESSION['error'])){
                              echo ('<p style= "color: red">'.htmlentities($_SESSION['error'])."</p>\n");
                              unset($_SESSION['error']);
                            } ?>
                            <form class="row contact_form" action="reset_password.php" method="post" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input type="password" class="form-control" id=" new_password" name="pw1" value=""
                                        placeholder="New Password">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="new_pass" name="pw2" value=""
                                        placeholder="Confirm Password">
                                </div>
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="submit" class="btn_3" name="reset">
                                        Reset
                                    </button>
                                    <button type="submit" value="submit" class="btn_3" name="cancel">
                                      Cancel
                                    </button>
                                    <a class="lost_pass" href="signup.php">create a new account</a>
                                </div>
                            </form>
                        </div>
                    </div>
